...
(() => {
  ...
  // src/cdn.ts
  // [aluzina] D-008: vendored runtime. The export pinned these on unpkg.com; the same bytes
  // (SRI verified 2026-09-20) live in ./vendor/ so the prototype loads with no CDN. Original
  // URLs are listed in vendor/README.md. (Font <link>s are rewritten in each page's <helmet>.)
