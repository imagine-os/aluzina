...
export default defineMeta({
  ...
  props: { label: 'string', value: 'ReactNode', hint: 'ReactNode?', tone: 'Tone?', glyph: 'string? – an icon name, a mapped Unicode glyph or text (resolved by glyphNode, D-064)', onActivate: '() => void?' },
