...
export default defineMeta({
  ...
  usages: ['S-12 archive browser (project covers, file grids)', 'DocumentViewer (page thumbnail strip)', 'project portal file lists', 'G-08 brand documents (document cards and company tiles)', 'PostCard on a file post (K-01 / K-02)', 'K-03 post file block', 'K-05 catalog Assets tab'],
});
