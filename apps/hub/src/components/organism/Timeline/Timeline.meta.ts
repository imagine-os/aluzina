...
export default defineMeta({
  ...
  a11y: ['role=group with aria-label', 'dates and dependencies are text next to each bar, never only geometry', 'bars are buttons only when onActivate is set, then 44 px tall and at least 44 px wide; label above bar under 768 px'],
