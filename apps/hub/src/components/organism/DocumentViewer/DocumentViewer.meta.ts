...
export default defineMeta({
  ...
  usages: ['S-12 archive project portal (file preview in a Drawer / Modal)', 'G-08 brand documents (the viewer Card and the company Drawer, ar-17)', 'K-03 Spaces post (file posts, in a Drawer)', 'K-05 Spaces catalog (Assets tab, in a Drawer)', 'P-05 public portfolio (planned)'],
});
