...
Codes are two digits, `01` is the dashboard, then `02..` in the order you build. Taken so far: A-01..A-07, O-01..O-10, S-01..S-09, G-01..G-07 (D-018), W-01..W-02, K-01..K-06, D-02..D-04; reserved by the hub cards for pass 0013: P-01 services + intake, C-01 client app, M-01 manual, D-05 plan viewer, D-06 docs, D-07 canvas, D-08 demo simulator, D-09 actions, D-10 tokens, D-11 testing hub (the hub card goes live when a built route with that code registers). Next free: A-08, O-11, S-10, G-08, C-02, P-02, M-02, D-12. Nav order: dashboards are `0`, Work is `5`, Spaces is `6` (its Graph / Catalog / Import are `61..63`), module pages start at `10`; the first four by order form the phone bottom nav. Use them in `spec.code`, `docs/pages/<CODE>.md`, `docs/screenshots/<CODE>/`, changelog `codes:` lines and commit bodies.
