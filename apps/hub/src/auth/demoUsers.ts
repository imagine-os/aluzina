 ...
 * (`docs/knowledge/team.md`); the client, the developer and the marketing strategist (no roster line yet, D-028) are invented. No real contact data.
 */
...
export const DEMO_USERS: readonly DemoUser[] = [
  ...
  { id: 'u-valentina', role: 'marketing', name: 'Valentina', initials: 'V', titleKey: 'core.role.marketing', email: 'valentina@demo.aluzina.local' },
